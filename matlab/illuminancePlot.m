...
function illuminancePlot(imap,ts,as,ta,tb,aa,ab)
...
illuminance_map(lux_img,ta,tb,aa,ab)
end

function illuminance_map(lmap,ta,tb,aa,ab)
...
cb5 = round(rg.*(1.^(1/gm)),3);figure(1);imshow(lumimg,'Colormap',crange);
title('\fontsize{16}\color[rgb]{0 .5 .5}illuminance Map');
